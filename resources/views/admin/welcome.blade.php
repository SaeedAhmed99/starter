            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
							<a href="#">
								<img class="header-logo-image" src="{{URL::asset('images/logo.svg')}}" alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Landing template for startups |
                                @if ($firstName == 'said')
                                    <span>Said Ahmed</span>
                                @else
                                    <span>Not Said</span>
                                @endif
                            ...
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src="{{URL::asset('images/feature-icon-01.svg')}}" alt="Feature 01">
                                    </div>
